...
#define USE_CONTROLLER_FAN
  ...
  #define CONTROLLERFAN_SPEED_IDLE      96 // (0-255) Idle speed, used when motors are disabled
...
#define CHAMBER_AUTO_FAN_PIN -1 //JH Will be FAN4_PIN
...
//JH TODO Decide if we should do this
//#define HOME_Z_FIRST                        // Home Z first. Requires a Z-MIN endstop (not a probe).

//JH TODO See if this is needed
...
#define ENCODER_RATE_MULTIPLIER
  ...
  #define ENCODER_10X_STEPS_PER_SEC   25  // (steps/s) Encoder rate for 10x speed
...
//#define BEEP_ON_FEEDRATE_CHANGE
  ...
  #define LED_CONTROL_MENU
    ...
    #define NEO2_COLOR_PRESETS                // Enable a second NeoPixel Preset Color menu option
      ...
      #define LED_USER_PRESET_RED         32  // User defined RED value
      #define LED_USER_PRESET_GREEN       32  // User defined GREEN value
      ...
      #define NEO2_USER_PRESET_RED        32   // User defined RED value
      #define NEO2_USER_PRESET_GREEN      32   // User defined GREEN value
...
// LCD Print Progress options
   ...
   */
  #define SDCARD_CONNECTION LCD //JH: FYSETC 12864
