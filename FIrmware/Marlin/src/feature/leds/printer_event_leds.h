...
private:
  ...
  static inline void set_done() { 
    #ifdef PRINTER_EVENT_LEDS_UPDATE_ALL
      TERN(LED_COLOR_PRESETS, { leds.set_default(); leds2.set_default(); }, { leds.set_off(); leds2.set_off(); ); 
    #else
      TERN(LED_COLOR_PRESETS, leds.set_default(), leds.set_off()); 
    #endif
...
public:
    ...
    static inline void onHeatingDone()             
    { 
      leds.set_white(); 
    #ifdef PRINTER_EVENT_LEDS_UPDATE_ALL
      leds2.set_white();
    ...
    static inline void onPidTuningDone(LEDColor c) 
    { 
      leds.set_color(c);
    #ifdef PRINTER_EVENT_LEDS_UPDATE_ALL
      leds2.set_white();
